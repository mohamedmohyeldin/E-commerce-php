                        ...
                        <div class="product__list another-product-style">
                            <?php 
                                ...
                                if(!empty($products)){
                                    ...
                                    echo "<div class='alert alert-warning text-center my-5'> No products yet </div>";
                                    $productsArray = [];
                                }
                                ...
                                <div class="product foo">
                                    <div class="product__inner">
                                        <div class="pro__thumb">
                                            <a href="#">
                                                <img src="http://<?php echo $_SERVER['HTTP_HOST'] ?>/nti/project 2/tmart/uploads/products/<?php echo $value['image'] ?>"  alt="product images">
                                            </a>
                                        </div>
                                    ...
                                    <div class="product__details">
                                        <h2><a href="product-details.php?pro=<?php echo $value['id'] ?>"><?php echo $value['name'] ?></a></h2>
                                        <ul class="product__price">
                                            <!-- <li class="old__price">$16.00</li> -->
                                            <li class="new__price"><?php echo $value['price'] ?> EGP</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
