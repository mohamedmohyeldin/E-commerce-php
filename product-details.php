            ...
            <div class="offsetmenu">
                <div class="offsetmenu__inner">
                    ...
                    <div class="off__contact">
                        ...
                        <p>xLorem ipsum dolor sit amet consectetu adipisicing elit sed do eiusmod tempor incididunt ut labore.</p>
                    </div>
                                        ...
                                        <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 smt-30 xmt-30">
                                            <div class="htc__product__details__inner">
                                                <div class="pro__detl__title">
                                                    <h2><?php echo $singlePro->name ?></h2>
                                                </div>
                                                <div class="pro__dtl__rating">
                                                    <ul class="pro__rating">
                                                        <?php
                                                            for($i=0;$i<$singlePro->rating_avg;$i++) {
                                                                ?>
                                                                <li><span class="ti-star"></span></li>
                                                                <?php
                                                            }
                                                            for($i=0;$i<(5-$singlePro->rating_avg);$i++){
                                                                ?>
                                                                <li><i class="ti-close"></i></li>
                                                                <?php
                                                            }
                                                        ?>

                                                    </ul>
                                                    <span class="rat__qun">(Based on <?php echo( $singlePro->rating_count == null ? 0 : $singlePro->rating_count) ?> Ratings)</span>
                                                </div>
                                                ...
                                                <ul class="pro__dtl__prize">
                                                    ...
                                                    <li><?php echo $singlePro->price ?> EGP</li>
                                                </ul>
                                                <?php 
                                                    include_once "specs.php";
                                                    $spec = new specs();
                                                    $spec->setProductId($singlePro->id);
                                                    $res = $spec->getProuctSpecs();
                                                    if(!empty($res)){
                                                        $specDB = $res->fetch_all(MYSQLI_ASSOC);
                                                    }else{
                                                        $specDB = [];
                                                    }
                                                    foreach($specDB AS $key=>$value){

                                                    
                                                ?>
                                                <div class="pro__dtl__color">
                                                    <h2 class="title__5"><?php echo $value['name']; ?></h2>
