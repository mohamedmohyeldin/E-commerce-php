                        ...
                        <div class="categories-menu mrg-xs">
                            ...
                            <div class="category-menu-list">
                                <ul>
                                    ...
                                    <li><a href="#"><img alt="" src="images/icons/thum2.png"> <?php echo $value['name'] ?> <i class="zmdi zmdi-chevron-right"></i></a>
                                            ...
                                            <div class="category-part-1 category-common mb--30">
                                                ...
                                                <ul>
                                                    <?php
                                                        ...
                                                        $sub->setCateID($value['id']);
                                                        $subcats = $sub->getSubCat();
                                                        if(!empty($subcats)){
                                                            $subCategories = $subcats->fetch_all(MYSQLI_ASSOC);
                                                        }else{
                                                            $subCategories = [];
                                                        }
                                                    ...
                                                    <li><a href="shop.php?subcat=<?php echo $value1['id']?>"> <?php echo $value1['name'] ?> </a></li>
                                                    <?php
                                                    }
                                                    ?>
                                                </ul>
